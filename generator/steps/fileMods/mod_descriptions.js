...
// -------------------------------------------------------->>>>>>>>>>>>> CHANGE HERE
// -------------------------------------------------------->>>>>>>>>>>>> CHANGE HERE
var fileContents = fs.readFileSync('./_OUTPUT/plugin/text/descriptions.js', {encoding: 'UTF-8'}).toString();
...
// -------------------------------------------------------->>>>>>>>>>>>> CHANGE HERE
// -------------------------------------------------------->>>>>>>>>>>>> CHANGE HERE
fs.writeFileSync('./_OUTPUT/plugin/text/descriptions.js', output);
